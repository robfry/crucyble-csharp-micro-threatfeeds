...
{
  public class ProtectWiseThreatConfigClass
  {

    [DataContract]
    public class ProtectWiseEvents
    {
      [DataMember]
      [JsonProperty("events")]
      public ProtectWiseSearchEvent[] Events { get; set; }
    ...
    [DataContract]
    public class ProtectWiseSearchEvent
    {
      [DataMember]
      [JsonProperty("cid")]
      ...
      public ProtectWiseObservation[] Observations { get; set; }

      [DataMember]
      [JsonProperty("netflows")]
      public ProtectWiseNetflow[] Netflow { get; set; }
    ...
    [DataContract]
    public class ProtectWiseObservation
    {
      [DataMember]
      [JsonProperty("agentId")]
    ...
    [DataContract]
    public class ProtectWiseNetflow
    {
      [DataMember]
      [JsonProperty("details")]
      public ProtectWiseFlowDetails FlowDetails { get; set; }
    ...
    [DataContract]
    public class ProtectWiseFlowDetails
    {
      [DataMember]
