...
using FileReport = FIDO.Threatfeeds.FIDO.Support.VirusTotal.NET.FileReport;

namespace FIDO.Threatfeeds.FIDO.Support.FidoDB
{
  public class FidoReturnValues
  {
    public ApiEndpointsClass.PrimaryConfig ApiConfig { get; set; }
    ...
    public MatrixHistoricalHelper.HostReturn PreviousAlerts { get; set; }
    public List<CouchDbAlertId.Row> OldAlerts { get; set; }
    public HistoricalEvents HistoricalEvent { get; set; }
    [DataMember]
    public GeoIpObject.Location Location { get; set; }
    [DataMember]
    public F5Vpn.ESVPN VPN { get; set; }
    [DataMember]
  ...
  public class Inventory
  {
    ...
    [DataMember]
    public CarbonBlackInventoryClass.CarbonBlackEntry CarbonBlack { get; set; }

    [DataMember]
    public SentinelOneInventoryClass.SentinelOne SentinelOne { get; set; }

    [DataMember]
    public F5VpnInventory VPN { get; set; }
  ...
  public class CyphortReturnValues
  {
    ...
    [DataMember]
    public OpenDNSClass OpenDNS { get; set; }
    [DataMember]
    public Bit9ReturnValues Bit9 { get; set; }
    [DataMember]
    public CyphortClass.CyphortIncident IncidentDetails { get; set; }
    [DataMember]
  ...
  public class ProtectWiseReturnValues
  {
    ...
    public Bit9ReturnValues Bit9 { get; set; }
    [DataMember]
    public List<ProtectWiseThreatConfigClass.ProtectWiseObservation> IncidentDetails { get; set; }
    [DataMember]
    public ProtectWiseThreatConfigClass.ProtectWise_GEO GEO { get; set; }
    [DataMember]
    public ProtectWiseThreatConfigClass.ProtectWiseSearchEvent EventDetails { get; set; }
    [DataMember]
  ...
  public class VirusTotalReturnValues
  {
    ...
    [DataMember]
    public List<IPReport> IPReturn { get; set; }
    [DataMember]
    public List<DomainReport> DomainReturn { get; set; }
    [DataMember]
  ...
  {
    public MatrixHistoricalHelper.Scoring domain { get; set; }
    public MatrixHistoricalHelper.Scoring dstip { get; set; }
    public MatrixHistoricalHelper.Scoring hash { get; set; }
    public MatrixHistoricalHelper.Scoring url { get; set; }
  }
  ...
  {
    [DataMember]
    public ThreatGridIpConfigClass.ThreatGRID_IP_HLInfo IPInfo { get; set; }
    [DataMember]
    public List<ThreatGridThreatConfigClass.ThreatGridThreatInfo> IPThreatInfo { get; set; }
    [DataMember]
    public List<ThreatGridSearchConfigClass.ThreatGRID_Search> IPSearch { get; set; }
    [DataMember]
    public List<ThreatGridThreatConfigClass.ThreatGridThreatInfo> HashThreatInfo { get; set; }
    [DataMember]
    public List<ThreatGridSearchConfigClass.ThreatGRID_Search> HashSearch { get; set; }
    [DataMember]
  ...
  {
    [DataMember]
    public SentinelOneAlertClass.SentinelOne Alert { get; set; }
    [DataMember]
    public VirusTotalReturnValues VirusTotal { get; set; }
    [DataMember]
    public ThreatGRIDReturnValues ThreatGRID { get; set; }
