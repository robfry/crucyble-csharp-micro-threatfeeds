...
namespace FIDO.Threatfeeds.FIDO.Support.Notification
{
  static class EmailSend
  {
    ...
    public static void Send(string sTo, string sCC, string sFrom, string sSubject, string sBody, List<string> lGaugeAttachment, string sEmailAttachment)
    {
      ...
      var getREST2 = new RestConnection();
      string request2 = APIEndpoints.PrimaryConfig.host + APIEndpoints.PrimaryConfig.fido_configs.app_configs.emailserver;
      ...
      var emailconfigs2 = new FidoEmailServerConfigs.EmailServer();
      if (!string.IsNullOrEmpty(stringreturn2))
      {
        emailconfigs2 = JsonConvert.DeserializeObject<FidoEmailServerConfigs.EmailServer>(stringreturn2);
